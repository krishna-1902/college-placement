<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_registration.aspx.cs" Inherits="Campus_Placement.student_registration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style94">
            <tr>
                <td class="auto-style93"><strong>::: Student Registration&nbsp; :::</strong></td>
            </tr>
        </table>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><asp:Label ID="Label3" runat="server" CssClass="auto-style118"></asp:Label>
                    ...
                    <td class="auto-style96">
                        <table class="auto-style95">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter Email" ForeColor="Red" ControlToValidate="mail"></asp:RequiredFieldValidator>
                                    <br />
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="mail" CssClass="auto-style118" ErrorMessage="Invalid Email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                    <br />
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="auto-style110">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" BorderColor="#33CC33" CssClass="auto-style111" ForeColor="Black" Height="29px" OnClick="Button1_Click" Text="Register" Width="131px" />
            </strong>
        </div>
    </form>
</body>
