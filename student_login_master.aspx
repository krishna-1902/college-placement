<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_login_master.aspx.cs" Inherits="Campus_Placement.student_login_master" %>
        ...
        <table class="auto-style6">
            <tr>
                ...
                <td class="auto-style56"><strong>
                    :: :: :: <asp:Label ID="Label3" runat="server" CssClass="auto-style10" Text="Find Company Here"></asp:Label>
                    &nbsp;:: :: ::</strong></td>
            ...
            <tr>
                <td class="auto-style7">
                    <asp:Image ID="Image2" runat="server" Height="166px" ImageUrl="~/geca_building.jpg" Width="233px" />
                </td>
            ...
            <tr>
                <td class="auto-style16">
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="Button3" runat="server" BackColor="#FFCCCC" BorderColor="#FF99FF" CssClass="auto-style18" Text="Apply For Job" Width="229px" OnClick="Button3_Click" />
                                </td>
                            <td>
                                &nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <strong>
                                <asp:Button ID="Button4" runat="server" BackColor="#FFCCCC" BorderColor="#FF99FF" CssClass="auto-style18" Text="Edit Profile" Width="229px" OnClick="Button4_Click" />
                                </strong>
                                </td>
                            <td>
                                &nbsp;</td>
                    ...
                    <table class="auto-style59">
                        <tr>
                            <td class="auto-style60">
                                <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="903px">
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Image ID="Image4" runat="server" Height="176px" ImageUrl="~/student_place.png" Width="223px" />
&nbsp;&nbsp; &nbsp;</td>
                        </tr>
                    </table>
                </td>
