<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_View_Profile.aspx.cs" Inherits="Campus_Placement.Company_View_Profile" %>
...
&nbsp; 
    ...
    <table class="auto-style5">
        <tr>
            <td class="auto-style20"><strong>:: :: :: Your Company Details :: :: ::</strong></td>
        </tr>
    </table>
</p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                ...
                <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333">
                    ...
                    <ItemTemplate>
                        <table class="auto-style5">
                            ...
                            <tr>
                                <td class="auto-style19">Contact Person&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                                <td class="auto-style18">:</td>
                                <td class="auto-style8"><strong>
                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("contact_person_name") %>'></asp:Label>
                                    </strong></td>
                                <td class="auto-style8">&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style19">Website&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                                <td class="auto-style18">:</td>
                                <td class="auto-style8"><strong>
                                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("website") %>'></asp:Label>
                                    </strong></td>
                                <td class="auto-style8">&nbsp;</td>
                            </tr>
                            <tr>
